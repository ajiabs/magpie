...
export class UsersIndexComponent extends  MagpieIndexComponent {
  ...
  constructor(route: ActivatedRoute, router: Router, fb: FormBuilder, http: HttpClient,section_service:SectionService,spinnerService: Ng4LoadingSpinnerService,webSocketService: WebsocketService) {
    super(route,router,fb,http,section_service,spinnerService,webSocketService);
   }
  ngOnInit(){
