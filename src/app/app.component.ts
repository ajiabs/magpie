    ...
    if (localStorage.getItem("current_segment") == 'admin') {
      ...
      this.router.events.subscribe(event => {
        if (event instanceof NavigationEnd) {
          ...
          if (event.url.split('/')[1] == 'admin' && event.urlAfterRedirects != '/admin/login' && event.urlAfterRedirects != '/admin/reset-password') {
            ...
            if (newUrl[0] == '/admin/reset-password') {
              ...
              th.getMenuNameFromUrl(custom_url).subscribe(res => {
                ...
                if (res != null) {
                  ...
                  th.showNavTitle = event.urlAfterRedirects.split('/')[2].replace(' ', '-');
